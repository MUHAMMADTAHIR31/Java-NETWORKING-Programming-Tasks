...
class P2PDataShiftingAgentJFrame extends JFrame{
	...
	static JTextField ipTextField  = new JTextField("127.0.0.1");
	...
	public P2PDataShiftingAgentJFrame( Socket socket ){
		this.socket = socket;
	...
	public static void main(String arg[])throws Exception{
		...
		Socket socket =new Socket(ipTextField.getText().toString(),9090);
			
		new P2PDataShiftingAgentJFrame(socket);
